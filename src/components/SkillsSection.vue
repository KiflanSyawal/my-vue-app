<template>
  <section class="skills-section reveal-on-scroll" id="Skills">
    ...
    <div class="skills-container">
      ...
      >
        <div class="skill-icon">
          <img :src="skill.icon" :alt="skill.name || 'Skill logo'">
        </div>
        <div v-if="skill.name" class="skill-name">{{ skill.name }}</div>
      </div>
    </div>
  </section>
</template>
